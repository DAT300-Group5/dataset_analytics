    ...
    def run_subprocess(self):
        ...
        try:
            with open(self.sql_file, 'r') as sql_input, \
                ...
                cmd_args = [self.cmd, str(self.db_file)]
...
if __name__ == "__main__":
    ...
    runner = DuckdbRunner(sql_file=sql_file, db_file=db_file, cwd=cwd, cmd="/Users/xiejiangzhao/tmp/chdb_cli", run_mode=RunMode.VALIDATE)
